...
public class lauth extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        pst.setString(1, request.getParameter("an"));
        pst.setString(2,request.getParameter("ap"));
        ResultSet rs =pst.executeQuery();
  
        if(rs.next()){
        HttpSession hs=request.getSession();
        hs.setAttribute("an",request.getParameter("an"));
        hs.setAttribute("ap", request.getParameter("ap"));
